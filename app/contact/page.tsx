...
export default function Contact() {
  return (
    <main className="h-screen w-full bg-black text-white antialiased flex flex-col relative overflow-hidden">
      ...
      <div className="flex-grow w-full max-w-5xl mx-auto flex flex-col justify-center items-center z-20 px-8 py-12 gap-y-16">
        ...
        <div className="text-center">
          ...
          <a 
            ...
            className="inline-block border border-white/20 px-12 py-4 text-[11px] uppercase tracking-[0.3em] hover:bg-white hover:text-black transition-all duration-300"
          >
            Apply here →
          </a>
        </div>
