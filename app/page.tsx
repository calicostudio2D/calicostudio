...
export default function Home() {
  return (
    <PageWrapper>
      <main className="h-screen w-full relative overflow-hidden bg-transparent text-white antialiased selection:bg-white selection:text-black">
        ...
        {/* Footer Info Derecha */}
        <div className="absolute bottom-8 right-0 w-full px-6 md:bottom-12 md:right-24 z-20 pointer-events-none text-center md:text-right">
