    ...
    <main className="h-screen w-full bg-black text-white antialiased flex flex-col relative overflow-hidden">
      ...
      <div className="flex-grow w-full max-w-5xl mx-auto flex flex-col justify-center items-center z-20 px-6">
        ...
        <div className="text-center">
          ...
          <h4 className="text-[9px] uppercase tracking-[0.3em] text-zinc-500 mb-6 font-light">Demo Reel</h4>
          
          {/* Título Principal */}
          <h1 className={`${montserrat.className} text-4xl md:text-6xl font-light tracking-tight text-white mb-6`}>
            In Progress
          </h1>
          
          {/* Descripción corta */}
          <p className={`${montserrat.className} text-zinc-400 font-light text-sm md:text-base tracking-wide max-w-lg mx-auto`}>
