  ...
  return (
    <PageWrapper>
      <main className="min-h-screen w-full bg-transparent text-white antialiased flex flex-col relative">
        <div className="relative z-20 flex flex-col items-center justify-center min-h-screen w-full max-w-5xl mx-auto px-4 pt-24 pb-12">
          
          <div className="text-center px-5 max-w-xl mb-12">
            <p className={`${montserrat.className} text-zinc-300 font-light text-xs md:text-base tracking-wide leading-relaxed`}>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 w-full px-2">
            {[ 
              ...
              <div 
                key={i} 
                className="group flex flex-col items-center text-center p-6 border border-white/10 bg-black/40 backdrop-blur-md rounded-xl transition-all duration-500 hover:border-white/30 hover:scale-[1.03] hover:bg-white/5 cursor-default"
              >
                <h3 className={`${montserrat.className} text-[10px] md:text-[12px] font-medium mb-3 tracking-widest uppercase text-white transition-colors duration-300 group-hover:text-zinc-200`}>
                  {service.title}
                </h3>
                <p className="text-[8px] md:text-[10px] text-zinc-400 font-light leading-relaxed group-hover:text-zinc-300">
                  {service.desc}
                </p>
              </div>
            ))}
