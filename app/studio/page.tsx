...
export default function Studio() {
  return (
    <main className="h-screen w-full bg-black text-white antialiased flex flex-col relative overflow-hidden">
      ...
      <div className="flex-grow w-full max-w-5xl mx-auto flex flex-col justify-center items-center z-20 px-6 mt-16 pb-4">
        
        {/* INTRODUCCIÓN - Texto ligeramente reducido para dar aire */}
        <div className="text-center mb-8">
          <h4 className="text-[9px] uppercase tracking-[0.3em] text-zinc-500 mb-3 font-light">The Studio</h4>
          <p className={`${montserrat.className} text-white font-light text-lg md:text-2xl tracking-wide max-w-2xl mx-auto drop-shadow-md leading-snug`}>
            We operate as a technical and creative development platform, bringing stories to life through 2D animation.
          </p>
        </div>

        {/* SECCIÓN EQUIPO - Protagonismo mantenido */}
