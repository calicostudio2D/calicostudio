...
export default function Studio() {
  return (
    <main className="h-screen w-full bg-black text-white antialiased flex flex-col relative overflow-hidden">
      ...
      <div className="flex-grow w-full max-w-6xl mx-auto flex flex-col justify-center items-center z-20 px-8 py-6 gap-y-10">
        
        <div className="text-center">
          <h4 className="text-[9px] uppercase tracking-[0.4em] text-zinc-500 mb-2 font-light">The Studio</h4>
          <p className={`${montserrat.className} text-zinc-200 font-light text-lg tracking-wide max-w-2xl mx-auto`}>
          ...
          <div className="flex flex-row justify-center items-center gap-10 w-full">
            {[ 
              ...
              <div key={i} className="flex flex-col items-center text-center">
                <div className="w-36 h-44 mb-3 rounded-lg overflow-hidden border border-white/10 shadow-2xl">
                ...
                <p className="text-[7px] uppercase tracking-[0.1em] text-zinc-500">{person.role}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center">
          ...
          <div className="w-48 opacity-80 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-500">
