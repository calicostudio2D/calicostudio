...
export default function Work() {
  return (
    <main className="h-screen w-full bg-black text-white antialiased flex flex-col relative overflow-hidden">
      ...
      <div className="flex-grow w-full max-w-6xl mx-auto flex flex-col justify-center items-center z-20 px-6 py-10 gap-y-8">
        <div className="text-center">
          <h4 className="text-[9px] uppercase tracking-[0.4em] text-zinc-500 mb-2 font-light">Our Work</h4>
          <p className={`${montserrat.className} text-zinc-100 font-light text-xl md:text-2xl tracking-wide`}>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 w-full">
          ...
          <div className="w-full md:w-2/5 text-center md:text-left">
            <p className="text-[9px] font-mono uppercase tracking-[0.3em] text-zinc-400 mb-2">Currently in production</p>
            <h3 className={`${montserrat.className} text-3xl md:text-6xl font-medium mb-4`}>Hora del Té</h3>
            <div className="space-y-2 text-xs md:text-base text-zinc-300 font-light">
